...
SQLite-хранилища используют общий пул соединений на приложение. На время операции берется свободное соединение из пула; если все соединения заняты, ожидание ограничено по времени (5 секунд)
