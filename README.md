...
Демо сохраняет настройки установки (`info_message`, `store`) и при приостановке решения, и при его удалении с аккаунта — чтобы пользователю не приходилось настраивать решение заново.
